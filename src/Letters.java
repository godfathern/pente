public class Letters {
    ...
    // Check horizontal I shape
        if (col + 2 < board[0].length && 
            ...
            ((row > 0 && board[row - 1][col] == ' ' && board[row - 1][col + 1] == ' ' && board[row - 1][col + 2] == ' ') ||
            (row < board.length - 1 && board[row + 1][col] == ' ' && board[row + 1][col + 1] == ' ' && board[row + 1][col + 2] == ' '))) {
            return 1;
        }
        ...
        if (row + 2 < board.length && 
            ...
            ((col > 0 && board[row][col - 1] == ' ' && board[row + 1][col - 1] == ' ' && board[row + 2][col - 1] == ' ') ||
            (col < board[0].length - 1 && board[row][col + 1] == ' ' && board[row + 1][col + 1] == ' ' && board[row + 2][col + 1] == ' '))) {
            return 1;
        }
        ...
        if (row + 2 < board.length && col + 2 < board[0].length && 
            ...
            ((row > 0 && col > 0 && board[row - 1][col - 1] == ' ' && board[row + 1][col + 1] == ' ') ||
            (row < board.length - 1 && col < board[0].length - 1 && board[row + 3][col + 3] == ' ' && board[row + 1][col + 1] == ' '))) {
            return 1;
        }
        ...
        if (row + 2 < board.length && col - 2 >= 0 && 
            ...
            ((row > 0 && col < board[0].length - 1 && board[row - 1][col + 1] == ' ' && board[row + 1][col - 1] == ' ') ||
            (row < board.length - 1 && col > 0 && board[row + 3][col - 3] == ' ' && board[row + 1][col - 1] == ' '))) {
            return 1;
        }
        return 0;
    }

    public static int lAdvancedShape(char[][] board, int row, int col, char player) {
